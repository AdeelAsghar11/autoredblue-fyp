...
- **Role split:** Adeel — Scan, Triage, Report, and Verification Agents plus all graph/orchestration engineering. Asad — Recon Agent, the Dashboard (UI module), and documentation (SRDS, diagrams, FYP report). See ARCHITECTURE.md for module detail.
